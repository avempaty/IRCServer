...
echo Send message
./TestIRCServer localhost $PORT "SEND-MESSAGE spiderman peterpark java-programming"

echo Get messages
./TestIRCServer localhost $PORT "GET-MESSAGES spiderman peterpark 0 java-programming"
